...
const uint8_t GeckoSpa::GO_RESP1[78] = {
...
const uint8_t GeckoSpa::GO_RESP2[78] = {
    0x17, 0x09, 0x00, 0x00, 0x00, 0x17, 0x0A, 0x01,
    0x00, 0x01, 0x00, 0x00, 0x40, 0xC7, 0x52, 0x51,
...
const uint8_t GeckoSpa::GO_RESP3[78] = {
    0x17, 0x09, 0x00, 0x00, 0x00, 0x17, 0x0A, 0x01,
    0x00, 0x01, 0x00, 0x00, 0x40, 0xC7, 0x52, 0x51,
...
const uint8_t GeckoSpa::GO_RESP4[23] = {
    0x17, 0x09, 0x00, 0x00, 0x00, 0x17, 0x0A, 0x01,
    0x00, 0x01, 0x00, 0x00, 0x09, 0xC7, 0x52, 0x51,
    0x00, 0xB1, 0x00, 0x00, 0x00, 0x01, 0x7E
};

const uint8_t GeckoSpa::GO_RESP5[2] = {0x17, 0x0A};
...
void GeckoSpa::process_i2c_message(const uint8_t *data, uint8_t len) {
  ...
  if (len == 15 && data[13] == 0x47 && data[14] == 0x4F) {
    ESP_LOGI(TAG, "Received GO message, sending response sequence");
    send_go_response();
    return;
  }
